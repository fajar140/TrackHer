    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textSelectionTheme: TextSelectionThemeData(
          ...
          selectionColor: const Color(0xFFeb858d).withOpacity(0.3), // Selection highlight color
          selectionHandleColor: const Color(0xFFeb858d), // Selection handle color
        ),
        ...
        textTheme: const TextTheme(
          bodyLarge: TextStyle(fontFamily: 'Poppins'), // Use bodyLarge instead of bodyText1
          bodyMedium: TextStyle(fontFamily: 'Poppins'), // Use bodyMedium instead of bodyText2
        ),
